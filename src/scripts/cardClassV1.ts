...
const createCardClosure = (initialCardData: CardData) => {
    ...
    const addActivity = (action: ActionType, description: string | null, _url: string | null) => {
        ...
        const activity: ActivityItem = {
            ...
            actionIcon,
            url,
            name: cardData.cardName, // Assuming we want to use cardName as the activity name
...
export const createCard = (cardName: string, type: ListType): ReturnType<typeof createCardClosure> => {
