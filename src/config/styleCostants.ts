...
export const PATTERNS = {
    ...
    FAQ_SECTION: {
        TITLE: `${SPACING.MARGIN.FAQ_TITLE} block-subtitle text-center`,
        HEADLINE: `${SPACING.MARGIN.FAQ_HEADLINE} block-subtitle text-center`,
        H2: `${SPACING.MARGIN.FAQ_H2} block-big-title text-center`
    },
    HERO: {
